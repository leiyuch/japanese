...
@TableName("t_educational_institution")
@ApiModel(value = "EducationalInstitution对象", description = "教育机构信息")
public class EducationalInstitutionEntity extends Model<EducationalInstitutionEntity> {
