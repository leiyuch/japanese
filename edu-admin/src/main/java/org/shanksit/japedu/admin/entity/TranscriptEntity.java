...
@TableName("t_transcript")
@ApiModel(value = "Transcript对象", description = "成绩单")
public class TranscriptEntity extends Model<TranscriptEntity> {
