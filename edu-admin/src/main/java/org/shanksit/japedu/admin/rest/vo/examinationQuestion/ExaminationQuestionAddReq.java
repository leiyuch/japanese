...
@Data
@ApiModel(value="ExaminationQuestionAddReq", description="试题")
public class ExaminationQuestionAddReq implements Serializable {
	...
	@ApiModelProperty(value = "题目类型  1 单选 2 多选 3 填空 4 判断  5问答  11 听力  12  完型填空 13  阅读理解 14 作文")
	@NotNull
	...
	private Long parentQuestion = 0L;
	//
	//@ApiModelProperty(value = "子问题列表,逗号分隔")
	...
	@ApiModelProperty(value = "子试题列，阅读理解 用")
	private List<ExaminationQuestionAddReq> children;
