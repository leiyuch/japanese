...
import org.shanksit.japedu.admin.vo.PermVo;
...
public class PermissionUtil {
    ...
    public static Set<String> listPermissionString(ApplicationContext context, String basicPackage) {
        Map<String, Object> map = context.getBeansWithAnnotation(Controller.class);
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            for (Method method : methods) {
                ...
                permissionsString.add(requiresPermissions.value()[0]);
            }
        }
